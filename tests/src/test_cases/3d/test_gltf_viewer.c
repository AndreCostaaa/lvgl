...
void test_gltf_viewer_env_brightness_and_exposure(void)
{
    ...
    lv_gltf_set_env_brightness(gltf, 250);
    TEST_ASSERT_EQUAL(250, lv_gltf_get_env_brightness(gltf));
    lv_gltf_set_env_brightness(gltf, 0);
    TEST_ASSERT_EQUAL(0, lv_gltf_get_env_brightness(gltf));
...
void test_gltf_viewer_settings_survive_a_render(void)
{
    ...
    lv_gltf_set_env_brightness(gltf, 180);
    ...
    TEST_ASSERT_EQUAL(180, lv_gltf_get_env_brightness(gltf));
