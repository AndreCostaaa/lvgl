...
static void draw_indic(lv_event_t * e)
{
    ...
    lv_area_copy_internal(&bar->indic_area, &bar_coords);
    ...
    */
    ...
    lv_area_copy_internal(&indic_area, &bar->indic_area);
...
{
    LV_ASSERT(obj != NULL);
    LV_ASSERT(value_ptr != NULL);
    LV_ASSERT(anim_info != NULL);
