...
if(CONFIG_LV_USE_PRIVATE_API)
    ...
    install(CODE "
        file(READ \"\${CMAKE_INSTALL_PREFIX}/include/lvgl_private/lvgl_public.h\" content)
        string(REPLACE \"../include/lvgl/lvgl.h\" \"../lvgl/lvgl.h\" content \"\${content}\")
        file(WRITE \"\${CMAKE_INSTALL_PREFIX}/include/lvgl_private/lvgl_public.h\" \"\${content}\")
    ")
endif()
