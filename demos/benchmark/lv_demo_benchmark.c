...
static lv_benchmark_summary_t summary_create(void);
...
static lv_benchmark_scene_dsc_t scenes[] = {
...
static lv_on_benchmark_end_cb_t on_demo_end_cb;
...
static void next_scene_timer_cb(lv_timer_t * timer)
{
    ...
    if(scenes[scene_act].scene_time == 0) {
        ...
        lv_benchmark_summary_t summary = summary_create();
...
static lv_benchmark_summary_t summary_create(void)
{
    lv_benchmark_summary_t summary = {
        .scenes = scenes,
        .total_avg_fps = 0,
        .total_avg_cpu = 0,
